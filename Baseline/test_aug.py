...
for checkpoint_file in glob.glob('./*.pt'):
    ...
    test_image_data = SlideDataset.SlideDataset('test', '../../settings/MSI_label.txt',
    ...
    for label in label_index:
        ...
        print(f'\tMSI Type: {label}, auc: {auc}')
...
for label in label_auc:
    ...
    print(f'\tMSI Type: {label}, AUC Mean: {mean}, Confidence Interval(0.95): [{lower}, {upper}]')
