...
train_image_data = SlideDataset.SlideDataset('train', '../../settings/MSI_label.txt', 
            '../../../gen_tiles/COAD_tiles_20X_1000/COAD_tiles/',  
...
val_image_data = SlideDataset.SlideDataset('val', '../../settings/MSI_label.txt', 
            '../../../gen_tiles/COAD_tiles_20X_1000/COAD_tiles/',  
            val_transform, fold)
...
writer = SummaryWriter(logdir="logs/Baseline_" + datetime.now().strftime('%b%d_%H-%M-%S'))
step = 0
...
for epoch in range(epoch_num):
    ...
    #with open("checkpoint/MINet_" + str(epoch) + ".pt", 'wb') as f: 
    #    torch.save(minet, f)
